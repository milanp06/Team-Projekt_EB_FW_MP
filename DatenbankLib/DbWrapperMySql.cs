...
// SINGLETON Wrapper
public class DbWrapperMySql
{
  // MERKMALE
  private static DbWrapperMySql? Instance = null;  // Das Singleton-Objekt
  private MySqlConnection connection = new("");
  private string connString = "";

  // PROPERTIES
  public static DbWrapperMySql Wrapper
  {
    get
    {
      if (Instance == null)               // Wenn es das einzige Objekt noch nicht gibt
        Instance = new DbWrapperMySql();  // -> erzeugen
      return Instance;
    }
  }
